...
namespace HotelManagement.Services
{
    public class Hotel : IHotel
    {
        ...
        public async Task<List<HotelResponse>> GetHotelData()
        {

            var Response = (Data==null? null : JsonConvert.DeserializeObject<List<HotelResponse>>(Data));
            return Response;
        }
        public async Task<HotelResponse> GetHotelData(int id)
        {
            var Response = (Data == null ? null : JsonConvert.DeserializeObject<List<HotelResponse>>(Data));
            
            var HotelData = ((Response== null || Response.Count == 0)?null : Response.FirstOrDefault(h => h.Id == id));
            return HotelData;
